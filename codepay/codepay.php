...
<head>
    ...
    <title><?php echo $typeName ?>扫码支付 - 充值<?php echo $price ?>元</title>
...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="time-item" id="msg">
            <h1>请在6分钟内完成付款</h1><font color="#FF0000">6分钟内完成</font>付款, 否则无法自动到账</p><br>失效倒计时：
            <strong id="minute_show">0分</strong>
            <strong id="second_show">0秒</strong>
        </div><br>
        <font color="#FF0000">付款金额必须一致</font>, 否则无法自动到账！
        <div class="tip">
