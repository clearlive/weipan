<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\qiantai/application/index\view\pay\kjpage.html";i:1553328513;s:72:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\qiantai/application/index\view\foot.html";i:1552983549;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form style="color: white;width: 100%;" class="tj" action="/index/pay/kjpage" method="post">

    <div style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 10%;">
        <text >卡号</text>
        <input style="flex: 2;height: 30px;margin-left: 15px"  type="text" name="card_no" />
    </div>
    <p>金额: &nbsp;&nbsp;<?php echo $price; ?> </p>
    <input  value=<?php echo $price; ?> type="hidden" name="price" />
