<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\code\weipan\weipan\qiantai/application/index\view\goods\goods.html";i:1552901375;s:62:"C:\code\weipan\weipan\qiantai/application/index\view\head.html";i:1552904453;}*/ ?>
﻿ <title><?php echo $pro['ptitle']; ?>  <?php echo !empty($userinfo['nickname'])?$userinfo['nickname']:$userinfo['username']; ?>  <?php echo $userinfo['utel']; ?> 余额：<?php echo $userinfo['usermoney']; ?> 元</title>﻿<html style="font-size: 120px;">
<head>
<meta charset="utf-8">
...
<div class="nav-bar-block" nav-bar="active"><ion-header-bar class="bar-stable headerbar bar bar-header" align-title="center"><div class="buttons buttons-left" style="transition-duration: 0ms;"><span class="left-buttons">
    ...
    </span></div><div class="title title-center header-item goodstitle" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); left: 48px; right: 48px;"> </div><div style="float:right;"></div></ion-header-bar></div></ion-nav-bar>
<ion-view   class="trade-view pane"  hide-nav-bar="false" state="trade" nav-view="active" style="opacity: 1; transform: translate3d(0%, 0px, 0px);">
	...
	<div class="trade_bar">
    <?php if($isopen == 1): ?>
		<section onclick="toggle_history_order_panel()" class=""><div style="float:left;"></div>
		<div class="title title-center header-item goodstitle" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); left: 48px; right: 48px;">$pro.ptitle}</div>
            <font color="#FFFFFF">在线: </font><font color="#FF0000"><strong><script type="text/javascript">var zaixian = 18280;
document.write(""+Math.round(zaixian+Math.random()*38610)+ "</strong></font> ");</script></font></a><font color="#FFFFFF">人 </font>
		</section>
            ...
            <div class="period">
                ...
                <ion-scroll direction="x" class="scroll-view ionic-scroll scroll-x"><div class="scroll" style="transform: translate3d(0px, 0px, 0px) scale(1);">
                    <div class="period-widget-view">
                        ...
                        <?php if(is_array($protime) || $protime instanceof \think\Collection || $protime instanceof \think\Paginator): $k = 0; $__LIST__ = $protime;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;endforeach; endif; else: echo "" ;endif; ?>

                        <!--<div class="period-widget <?php if($k==1): ?> active <?php endif; ?>"  data-sen="<?php echo $vo*7.5; ?>" data-shouyi="<?php echo $proscale[$k-3]; ?>">-->
                            <!--<div class="period-widget-header">-->
                                <!--结算时间-->
                            <!--</div>-->
                            <!--<div class="period-widget-content" >-->
                                <!--<span  class="final_time ng-binding"><?php echo $vo*7.5; ?></span>-->
                                <!--<span  class="final_unit">秒</span>-->
                            <!--</div>-->
                            <!--<div class="period-widget-footer period_footer ng-binding">-->
                                <!--收益  <?php echo $proscale[$k-3]; ?>%-->
                            <!--</div>-->
                        <!--</div>-->

                        <div class="period-widget <?php if($k==1): endif; ?>"  data-sen="<?php echo $vo*15; ?>" data-shouyi="<?php echo $proscale[$k-3]; ?>">
                            <div class="period-widget-header">
                                结算时间
                            </div>
                            <div class="period-widget-content" >
                                <span  class="final_time ng-binding">30</span>
                                <span  class="final_unit">秒</span>
                            </div>
                            <div class="period-widget-footer period_footer ng-binding">
                                收益  <?php echo $proscale[$k-3]; ?>%
                        ...
                        <div class="period-widget <?php if($k==1): endif; ?>"  data-sen="<?php echo $vo*30; ?>" data-shouyi="<?php echo $proscale[$k=1]; ?>">
                            <div class="period-widget-header">
                                结算时间
                            </div>
                            <div class="period-widget-content" >
                                <span  class="final_time ng-binding">1</span>
                                <span  class="final_unit">分钟</span>
                            </div>
                            <div class="period-widget-footer period_footer ng-binding">
                        ...
                        <div class="period-widget <?php if($k==1): endif; ?>"  data-sen="<?php echo $vo*60; ?>" data-shouyi="<?php echo $proscale[$k+1]; ?>">
                            <div class="period-widget-header">
                                结算时间
                            </div>
                            <div class="period-widget-content" >
                                <span  class="final_time ng-binding">2</span>
                                <span  class="final_unit">分钟</span>
                            </div>
                            <div class="period-widget-footer period_footer ng-binding">
                                收益  <?php echo $proscale[$k+1]; ?>%
            ...
            <div class="order-detail-view">
                <div class="order-detail">
                    ...
                    <p class="expect_profit">
                        <span class="ng-binding">预期收益 :  ￥ <span id="yuqi">190.00</span></span>
                        &nbsp;&nbsp;
            ...
            <div class="panel-header">
                <div class="ng-binding goodstitle">
                    ...
                    <div class="close" onclick="close_order()" ">
                        <i class="icon ion-ios-close-empty">1</i>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                ...
                <div class="ordersuccess ng-hide" style="">
                    <div class="row remaining finish_remaining">
                        <div class="col">
                            <div class="result_profit ng-binding "  style="">￥190</div>
