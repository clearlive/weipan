...
BillNo = "ecpss_bank"&orderTime'orderTime' "1"					'[必填]订单号(商户自己产生：要求不重复)
Amount = request("pay_money")'"0.01"				'[必填]订单金额

OrderDesc=""				'[选填]选填订单描述
AdviceURL="http://"&request.ServerVariables("HTTP_HOST")&"/ecpss/receive.asp"



ReturnURL =AdviceURL	'[必填]返回数据给商户的地址(商户自己填写):::注意请在测试前将该地址告诉我方人员;否则测试通不过。这个文件在我们的接口包里有参考receive.asp
...
defaultBankNumber =""'request("selCardType")
