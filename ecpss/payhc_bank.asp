...
<div class="p-u-s">
<div class="p-u-s-z"><span class="l">您充值的是：<font color="#FF0000"><strong>平台币</strong></font></span><span class="r">充值方式：<span style=" color:#F70D04" class="chongzhimingcheng">网银支付</span><span style=" color:#F70D04" class="wangshangyinhang"></span></span></div>
...
<form target="_blank" method="post" action="send.asp" id="adads"  >
